...
function Footer() {
    ...
    return (
        <footer className="bg-gray-900 py-8 px-10 font-[sans-serif]">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="lg:flex lg:items-center">
                    <a href="#" className="w-48 text-white">
                        STAR CODING
            ...
            <p className='text-gray-300 text-sm mt-8'>© 2024<a href='https://readymadeui.com/' target='_blank'
                className="hover:underline mx-1">Star Coding</a>All Rights Reserved.
            </p>
        </footer>
    )
}
